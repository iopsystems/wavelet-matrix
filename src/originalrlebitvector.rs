...
mod tests {
    ...
    use crate::{rlebitvector::*, simplebitvector::SimpleBitVector};
    ...
    fn compare_bitvecs() {
        ...
        for _ in 0..100 {
            ...
            let mut bb3 = SimpleBitVector::builder(10_000_000); // give it a generous size
